                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="w-full">
                                                ...
                                                <div className="text-gray-500 text-sm line-clamp-1">Invoice: {item.invoice || "-"}</div>
                                                <div className="text-gray-500 text-sm line-clamp-1 max-w-[155px]">Pelanggan: {item.customer_name || "-"}</div>
                                            </div>
                                        </div>
