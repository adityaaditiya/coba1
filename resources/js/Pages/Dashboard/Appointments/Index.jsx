...
export default function Index({ appointments = [], selectedStartDate, selectedEndDate }) {
    ...
    const closeParticipantsModal = () => {
        setParticipantAppointment(null);
    };

    const updateAttendanceStatus = (bookingId, attendanceStatus) => {
        router.patch(
            route("appointments.bookings.attendance", bookingId),
                ...
                >
                    ...
                    <div className="mt-6 flex flex-wrap items-center gap-2">
                        ...
                        <div className="flex gap-2">
                            <button
                                type="button"
                                onClick={() => openParticipantsModal(appointment)}
            ...
            <Modal title="Detail Appointment" show={Boolean(selectedAppointment)} onClose={closeAppointmentDetail} maxWidth="2xl">
                {selectedAppointment && (
                    <div className="space-y-4 p-1">
                        ...
                        <button
                            type="button"
                            onClick={() => router.get(route("appointments.bookings.create", selectedAppointment.id))}
