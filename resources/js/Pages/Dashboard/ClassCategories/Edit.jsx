...
export default function Edit({ classCategory }) {
    ...
    const [imagePreview, setImagePreview] = useState(classCategory.image || null);
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("class-categories.update", classCategory.id), {
onError: () => toast.error("Gagal memperbarui kategori kelas"),
        });
    };

    return (
        <>
            <Head title="Edit Kategori Kelas" />
            ...
            <div className="mb-6">
                ...
                >
                    ...
                    Kembali ke Kategori Kelas
                </Link>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
                    <IconCategory size={28} className="text-primary-500" />
                    Edit Kategori Kelas
                </h1>
                <p className="text-sm text-slate-500 mt-1">{classCategory.name}</p>
            </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <Textarea
                                    label="Deskripsi"
                                    placeholder="Deskripsi kategori kelas"
