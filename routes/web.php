...
Route::middleware('auth')->post('/welcome/appointment/questionnaire', [StudioPageController::class, 'submitAppointmentQuestionnaire'])->name('welcome.appointment-questionnaire.submit');
...
Route::middleware('auth')->get('/welcome/membership-plans/{membershipPlan}/checkout', [StudioPageController::class, 'showMembershipCheckout'])->name('welcome.membership-checkout');
Route::middleware('auth')->post('/welcome/membership-plans/{membershipPlan}/checkout', [StudioPageController::class, 'processMembershipCheckout'])->name('welcome.membership-checkout.process');
Route::middleware('auth')->post('/welcome/memberships/{userMembership}/payment-proof', [StudioPageController::class, 'uploadMembershipPaymentProof'])->name('welcome.membership-checkout.upload-proof');
...
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth']], function () {
    ...
    Route::post('/customers/{customer}/assign-trainer', [CustomerController::class, 'assignTrainer'])->name('customers.assign-trainer');
    ...
    Route::get('memberships/extensions', [MembershipExtensionController::class, 'index'])->middleware('permission:membership-extension-access')->name('memberships.extensions.index');
    Route::post('memberships/extensions', [MembershipExtensionController::class, 'store'])->middleware('permission:membership-extension-access')->name('memberships.extensions.store');
